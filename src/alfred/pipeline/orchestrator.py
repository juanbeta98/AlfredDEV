...
from alfred.utils.datetime_utils import utc_to_colombia_series
from alfred.utils.logging_utils import set_run_id, setup_logging_context, add_file_log_handler
from alfred.data.api.client import ALFREDAPIClient
from alfred.data.api.sender import ResultSender
from alfred.data.io.input_loader import load_local_input
from alfred.data.io.request_loader import (
...
from alfred.data.io.output_writer import (
...
from alfred.data.formatting.output_formatter import OutputFormatter
...
from alfred.optimization.validation.solution_validator import validate_solution
from alfred.optimization.common.preassigned import _prepare_service_rows_for_reassignment
from alfred.pipeline.helpers import (
...
from alfred.pipeline.diagnostics import (
...
# ======================================================
def main() -> int:
    from alfred.data.io.artifact_naming import build_run_subdir, write_run_manifest, finalize_run_manifest
    ...
    try:
        ...
        if _mask_path:
            from alfred.data.io.service_mask import apply_service_mask, load_labor_ids_from_snapshot
