...
def build_preassigned_state(
    ...
    *,
    ...
    from alfred.optimization.common.movements import build_driver_movements
...
def reconstruct_preassigned_state(
    ...
    *,
    ...
    from alfred.optimization.algorithms.offline.offline_algorithms import assign_task_to_driver, init_drivers
    from alfred.optimization.common.movements import build_driver_movements
    from alfred.optimization.common.distance_utils import distance
